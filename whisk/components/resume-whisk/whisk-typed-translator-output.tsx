...
} from "./whisk-translator-textarea";

/** 스크롤·고정 높이 박스. typed.js 커서는 `el`의 다음 형제로 삽입되므로, 타이핑 타깃은 반드시 이 안의 `span`이어야 합니다. */
export const whiskTranslatorOutputShellClass = cn(
  "whisk-typed-output-shell field-sizing-fixed block !min-h-0 min-w-0 w-full shrink-0 overflow-y-auto border-0 bg-transparent px-0 py-2 text-left shadow-none",
  whiskTranslatorFieldTypographyClass,
  whiskTranslatorFieldHeightClass,
);
...
export const whiskTranslatorOutputInnerClass =
  "inline min-w-0 max-w-full whitespace-pre-wrap break-words [vertical-align:baseline]";
